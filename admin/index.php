...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-10">
    ...
    <!-- STAT CARD 1 -->
    <div class="group bg-gradient-to-br from-[#0B6623] to-[#1a8c35] p-4 sm:p-6 rounded-[20px] sm:rounded-[24px] shadow-lg shadow-green-900/20 text-white relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 animate-slide-up">
        ...
        <div class="flex justify-between items-start relative z-10">
            <div>
                <p class="text-green-100 text-xs sm:text-sm font-semibold mb-1 uppercase tracking-wide">แคมเปญที่เปิดอยู่</p>
                <h3 id="stat-total" class="text-3xl sm:text-4xl font-black transition-all duration-300"><?= number_format((float)$stats['total_campaigns']) ?></h3>
            </div>
            <div class="w-10 h-10 sm:w-14 sm:h-14 bg-white/20 backdrop-blur-md rounded-xl sm:rounded-2xl flex items-center justify-center text-white shadow-inner">
                <i class="fa-solid fa-bullhorn text-lg sm:text-2xl"></i>
            </div>
        </div>
        <div class="mt-3 sm:mt-4 flex items-center gap-2 text-xs text-green-100/80 font-medium">
            <i class="fa-solid fa-chart-line"></i> <span class="hidden sm:inline">แคมเปญทั้งหมดที่มีสถานะ Active</span><span class="sm:hidden">Active campaigns</span>
        </div>
    </div>
    ...
    <!-- STAT CARD 3 -->
    <div class="group bg-white p-4 sm:p-6 rounded-[20px] sm:rounded-[24px] shadow-sm border border-gray-100 relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-1 animate-slide-up delay-200">
        ...
        <div class="flex justify-between items-start">
            ...
            <div class="w-10 h-10 sm:w-14 sm:h-14 bg-blue-50 text-blue-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-inner">
                <i class="fa-solid fa-check-double text-lg sm:text-2xl"></i>
            </div>
        </div>
        <div class="mt-3 sm:mt-4 flex items-center gap-2 text-xs text-blue-600 font-semibold bg-blue-50 w-max px-3 py-1 rounded-full">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-8 animate-slide-up delay-200">
                ...
                <?php else: ?>
                    ...
                    <div class="group flex justify-between items-center p-2.5 sm:p-3 rounded-2xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100 gap-3">
                        <div class="flex items-center gap-3 sm:gap-4 min-w-0">
                            ...
                            <span class="text-gray-800 font-semibold group-hover:text-blue-600 transition-colors text-sm truncate"><?= htmlspecialchars($pc['title']) ?></span>
                        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 flex-1">
        ...
        <a href="campaigns.php" class="relative overflow-hidden bg-gradient-to-br from-[#0052CC] to-[#0043a8] text-white p-5 sm:p-8 rounded-[20px] sm:rounded-[24px] flex flex-col justify-between hover:shadow-xl hover:shadow-blue-900/20 hover:-translate-y-1 transition-all group">
            ...
            <div>
                ...
                <span class="text-blue-100 text-xs sm:text-sm">เริ่มต้นเปิดโครงการใหม่ให้คนเข้ามาจองสิทธิ์</span>
            </div>
        ...
        <a href="bookings.php" class="relative overflow-hidden bg-white border border-gray-100 p-5 sm:p-8 rounded-[20px] sm:rounded-[24px] flex flex-col justify-between hover:border-blue-200 hover:shadow-xl hover:shadow-blue-500/5 hover:-translate-y-1 transition-all group">
            <div class="w-11 h-11 sm:w-14 sm:h-14 bg-blue-50 text-[#0052CC] rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6">
                <i class="fa-solid fa-users text-lg sm:text-2xl"></i>
            </div>
            <div>
                <span class="block font-black text-gray-900 text-lg sm:text-xl mb-1 group-hover:text-[#0052CC] transition-colors">จัดการผู้จอง</span>
                <span class="text-gray-500 text-xs sm:text-sm">ตรวจสอบ อนุมัติ และจัดการรายชื่อทั้งหมด</span>
            </div>
            <i class="fa-solid fa-arrow-right absolute bottom-5 right-5 sm:bottom-8 sm:right-8 text-xl text-[#0052CC] opacity-0 -translate-x-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0"></i>
        </a>
