    ...
    <div class="modal-glass w-full max-w-lg mx-auto my-6 overflow-hidden animate-slide-up">
        ...
        <form method="POST" class="p-5 space-y-4 bg-white overflow-y-auto custom-scrollbar" style="max-height:calc(100vh - 140px)">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <div>
                    <label class="form-label">URL รูปหน้าปก <span class="text-gray-400 font-normal">(ไม่บังคับ)</span></label>
                    <div class="relative">
                        <i class="form-input-icon fa-regular fa-image"></i>
                        <input type="url" id="modal_cover_image" name="cover_image" placeholder="https://..."
                            class="form-input">
                    </div>
                </div>
            </div>
...
<script>
    ...
    function openAddModal() {
        ...
        document.getElementById('modal_cover_image').value = '';
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.edit-btn').forEach(btn => {
            btn.addEventListener('click', function () {
                ...
                document.getElementById('modal_cover_image').value = this.dataset.cover || '';
