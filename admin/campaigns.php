            ...
            <?php else: ?>
                <?php foreach ($camp_list as $c):
                    ...
                    <tr class="glass-tr group campaign-row <?= $isInactive ? 'is-inactive' : 'is-active' ?>" style="<?= $isInactive ? 'opacity:.55' : '' ?>">
                        ...
                        <td class="px-4 py-4 text-center sticky right-0 bg-white group-hover:bg-[#f0fdf4] z-10 transition-colors" style="box-shadow:-6px 0 15px rgba(0,0,0,0.03); border-left:1px solid #f0f4fa">
                            <div class="flex items-center justify-center gap-3">
                                <!-- Group 1: Sharing & Access -->
