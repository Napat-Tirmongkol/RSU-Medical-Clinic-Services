...
<div class="glass-table-container animate-slide-up delay-100 mb-10 overflow-x-auto">
    <table class="w-full text-left text-sm" style="table-layout:fixed; min-width:720px">
        <colgroup>
            <col><!-- title: flexible -->
            <col style="width:150px"><!-- date -->
            <col style="width:120px"><!-- seats -->
            <col style="width:150px"><!-- status -->
            <col style="width:150px"><!-- actions: 3 buttons × 36px + 2 gaps × 8px + padding 24px = 148px -->
        </colgroup>
        <thead>
            <tr>
        ...
        <form method="POST" enctype="multipart/form-data" class="p-5 space-y-4 bg-white overflow-y-auto custom-scrollbar" style="max-height:calc(100vh - 140px)">
            ...
            <div id="modal-vaccine-type-wrap">
                ...
                <?php if (empty($vaccineTypes)): ?>
                    <p class="text-[11px] text-amber-600 mt-1"><i class="fa-solid fa-circle-info"></i> ยังไม่มี vaccine catalog ใน Portal · เปิด <a href="../portal/vaccine_catalog.php" target="_blank" class="underline font-bold">ประเภทวัคซีน</a> เพื่อเพิ่ม</p>
                <?php endif; ?>
            </div>
            ...
            <div>
                <label class="form-label">
                    ...
                    <a href="../portal/clinic_data.php?cd_view=rooms" target="_blank" rel="noopener"
