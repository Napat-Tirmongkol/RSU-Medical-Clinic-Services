...
<?php if (isset($db_error)): ?>
    <div class="mb-6 p-6 bg-red-50 border-2 border-red-200 rounded-3xl animate-slide-up">
        ...
        <p class="mt-4 text-xs text-red-500 font-bold"><i class="fa-solid fa-triangle-exclamation text-red-500 mr-1"></i> คำแนะนำ: ตรวจสอบว่ามีตาราง "sys_activity_logs" ในฐานข้อมูล "rsu-clinic_db" หรือยัง</p>
    </div>
<?php endif; ?>
