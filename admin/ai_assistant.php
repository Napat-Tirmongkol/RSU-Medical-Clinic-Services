...
<div class="api-warn mb-6 fade-up">
    ...
    <div>
        ...
        <div>กรุณาไปที่เมนู <a href="../portal/settings.php" class="font-bold underline">Settings</a> ในหน้า Portal เพื่อกรอก API Key ของ Gemini ก่อนใช้งานระบบผู้ช่วย AI ครับ<br>
