<?php
// e_campaign_help.php — แสดง E_CAMPAIGN_GUIDE.md เป็นหน้า in-app help
// Render markdown โดย marked.js (CDN) — ไม่ expose .md file ผ่าน URL โดยตรง
declare(strict_types=1);

$mdPath = __DIR__ . '/E_CAMPAIGN_GUIDE.md';
...
<head>
    ...
    <title>คู่มือใช้งานระบบ e-Campaign</title>
...
<body>
    <header class="topbar">
        <h1><i class="fa-solid fa-bullhorn" style="color:#10b981"></i>คู่มือ e-Campaign</h1>
        <div class="actions">
        ...
        (function() {
            if (!MD_CONTENT) {
                document.getElementById('content').innerHTML =
                    ...
                    '<i class="fa-solid fa-triangle-exclamation"></i> ไม่พบไฟล์คู่มือ (E_CAMPAIGN_GUIDE.md)</p>';
                return;
            }
