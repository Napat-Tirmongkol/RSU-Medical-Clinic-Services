<?php
/**
 * portal/billing_invoices.php
 * Patient Billing — Invoice management + payment recording
 */
require __DIR__ . '/_init.php';
require_once __DIR__ . '/_layout.php';

layout_start(['section' => 'billing_invoices', 'title' => 'ใบแจ้งหนี้ + รับชำระ (Invoices)']);
?>
            <div id="section-billing_invoices" class="portal-section"
                ...
                if ($isSuper || $adminRole === 'admin' || !empty($_SESSION['access_finance'])) {
                    include __DIR__ . '/_partials/billing_invoices.php';
                } else {
