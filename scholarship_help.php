<?php
// scholarship_help.php — แสดง SCHOLARSHIP_GUIDE.md เป็นหน้า in-app help
// Render markdown โดย marked.js (CDN) — ไม่ expose .md file ผ่าน URL โดยตรง
declare(strict_types=1);

$mdPath = __DIR__ . '/SCHOLARSHIP_GUIDE.md';
...
<head>
    ...
    <title>คู่มือใช้งานระบบนักศึกษาทุน</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .topbar h1 {
            margin: 0; font-size: 16px; font-weight: 900; color: #065f46;
        ...
        .toc a:hover { background: #ecfdf5; color: #065f46; }
        .toc a.active { background: #10b981; color: #fff; }
        ...
        .content h1 {
            font-size: 26px; font-weight: 900; color: #065f46;
            margin: 0 0 12px; line-height: 1.3;
            padding-bottom: 12px; border-bottom: 3px solid #10b981;
        }
        .content h2 {
...
<body>
    <header class="topbar">
        <h1><i class="fa-solid fa-book-open" style="color:#10b981"></i>คู่มือนักศึกษาทุน</h1>
        <div class="actions">
        ...
        (function() {
            if (!MD_CONTENT) {
                document.getElementById('content').innerHTML =
                    ...
                    '<i class="fa-solid fa-triangle-exclamation"></i> ไม่พบไฟล์คู่มือ (SCHOLARSHIP_GUIDE.md)</p>';
                return;
            }
