                    ...
                    <div class="bg-white rounded-[2rem] p-6 shadow-xl relative overflow-hidden border border-slate-100">
                        ...
                        <div class="flex items-start justify-between mb-5 relative z-10 gap-3">
                            ...
                            <div class="text-right shrink-0">
                                <p class="text-rose-500 font-black text-xl leading-none tracking-tight">RSU</p>
                                <p class="text-rose-400 font-black text-[8px] uppercase tracking-[0.2em] mt-0.5">Medical Clinic</p>
