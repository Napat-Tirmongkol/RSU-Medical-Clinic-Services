        ...
        <div
            ...
            <div class="flex items-start justify-between gap-5 border-b border-slate-200 bg-white px-6 py-5 sm:px-8">
                <div class="min-w-0">
                    ...
                    <h3 class="text-xl font-black tracking-tight text-slate-900">ประวัติการฉีดวัคซีน</h3>
                    <p class="mt-1 text-xs font-semibold text-slate-500">รายการวัคซีนที่บันทึกไว้ในระบบของคุณ</p>
                </div>
