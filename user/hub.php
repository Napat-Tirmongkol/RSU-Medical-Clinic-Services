            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-[3rem] border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.04)] p-6 pt-8">
                    <div class="grid grid-cols-2 gap-4 mb-8">
                        ...
                        <a href="my_bookings.php" class="relative flex flex-col items-start p-6 rounded-[2.2rem] bg-indigo-50 border border-indigo-100 shadow-sm active:scale-95 transition-all text-indigo-600 group">
                            <?php if ($upcoming_count > 0): ?>
