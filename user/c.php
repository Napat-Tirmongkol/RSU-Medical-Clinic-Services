...
<?php if (!$campaign): ?>
  ...
  <div class="flex flex-col items-center justify-center py-20 text-center">
    ...
    <a href="booking_campaign.php" class="bg-[#2e9e63] text-white px-6 py-3 rounded-2xl font-bold text-sm shadow-lg shadow-blue-200 transition-all hover:bg-green-700 active:scale-95">
...
<?php elseif ($isInactive): ?>
  ...
  <div class="mt-6 text-center">
    <a href="booking_campaign.php" class="text-sm font-bold text-gray-400 hover:text-[#2e9e63] transition-colors">
...
<?php else: ?>
  ...
  <!-- Invite banner -->
  <div class="bg-gradient-to-br from-[#2e9e63] to-[#3bba7a] rounded-3xl p-5 mb-6 text-white relative overflow-hidden">
  ...
  <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
    ...
    <div class="p-6">
      ...
      <?php if ($campaign['is_auto_approve']): ?>
        <div class="flex items-center gap-2 text-xs font-bold text-[#2e9e63] bg-blue-50 rounded-xl px-3 py-2 mb-5">
  ...
  <div class="mt-6 space-y-3">
    <?php if (!$isFull): ?>
      <a href="booking_date.php?campaign_id=<?= (int)$campaign['id'] ?>"
         class="flex items-center justify-center gap-3 w-full bg-[#2e9e63] hover:bg-green-700 text-white font-bold py-4 rounded-2xl shadow-lg shadow-blue-200 transition-all active:scale-[0.98] text-base">
    ...
    <?php endif; ?>
    <a href="my_bookings.php" class="flex items-center justify-center gap-2 w-full py-3 text-sm font-bold text-gray-400 hover:text-[#2e9e63] transition-colors">
