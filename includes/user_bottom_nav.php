...
<nav class="fixed bottom-0 left-0 right-0 z-[70] bg-white/90 backdrop-blur-2xl border-t border-slate-50 px-8 py-4 pb-10 flex justify-between items-center max-w-md mx-auto shadow-[0_-20px_40px_rgba(0,0,0,0.04)]">
    <button onclick="window.location.href='hub.php'" class="<?= _navClass('home', $__navActive) ?>">
        <i class="fa-solid fa-house-chimney text-xl"></i>
        <span class="text-[8px] font-black uppercase tracking-[0.1em]">Home</span>
    </button>
    <button onclick="window.location.href='my_bookings.php'" class="<?= _navClass('booking', $__navActive) ?>">
    ...
    <button onclick="window.location.href='hub.php#health'" class="<?= _navClass('health', $__navActive) ?>">
        <i class="fa-solid fa-heart-pulse text-xl"></i>
        <span class="text-[8px] font-black uppercase tracking-[0.1em]">Health</span>
    </button>
    <button onclick="window.location.href='profile.php'" class="<?= _navClass('account', $__navActive) ?>">
