...
**กลุ่มผู้ใช้สิทธิ์ในระบบ:**
- 👨‍⚕️ **บุคลากร** — เจ้าหน้าที่ในมหาวิทยาลัย (admin บันทึก/อัพโหลดเอกสารให้)
- 🎓 **นักศึกษา** — นักศึกษา RSU (สมัครเองผ่าน LINE ได้)
- 🧑 **บุคคลทั่วไป** — คนนอก (admin บันทึกให้)

> ⚠️ **กฎสำคัญ:** ระบบสมัครผ่าน LINE (LIFF) **เปิดให้เฉพาะนักศึกษา** (`sys_users.status = 'student'`) เท่านั้น
> หากผู้ใช้เป็นบุคลากร/บุคคลทั่วไป จะไม่เห็นปุ่ม "สมัครบัตรทอง" ที่หน้า hub และถ้าพยายามเข้า URL ตรงๆ จะขึ้นข้อความ "ระบบบัตรทองเปิดให้สมัครเฉพาะนักศึกษา"
> สำหรับสองกลุ่มที่เหลือ admin บันทึกข้อมูล + อัพโหลดเอกสารให้โดยตรงในระบบ Portal
...
- ระบบเช็คเงื่อนไข:
  ...
  - **`sys_users.status` ต้องเป็น `'student'`** (เฉพาะนักศึกษาเท่านั้น) — บุคลากร/บุคคลทั่วไปจะถูก block พร้อมข้อความแนะนำให้ติดต่อเจ้าหน้าที่
...
| User: ขึ้น "สมัครได้เฉพาะนักศึกษา" | ผู้ใช้คนนี้ `sys_users.status ≠ 'student'` — admin สามารถบันทึกบัตรทองให้แทนได้ที่ Portal |
