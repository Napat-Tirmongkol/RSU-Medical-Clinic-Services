...
8. **ติดตามระบบ** (icon: `fa-binoculars`) — Activity Logs, Error Logs
9. *(spacer `<div style="flex:1"></div>`)*
10. **ข้อมูลหลัก** (icon: `fa-database`) — ข้อมูลคลินิก, นักศึกษาทุน, Master Data อื่นๆ
11. **ตั้งค่า** (icon: `fa-gear`) — Settings (อยู่ล่างสุดเสมอ)
